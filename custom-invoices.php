...
"<a class='nav-link' href='custom-invoices.php'>Custom invoices<span class='sr-only'>(current)</span></a>".
"</li>".
"<li class='nav-item'>".
...
"<div class='main'>".
"<script>".
"setInterval(function(){window.location.replace('signin.php')},5000);".
"</script>".
"</div>".
